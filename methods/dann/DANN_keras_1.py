...
# load data
def load_data_iter(data_name, dkeys, suffix='train'):
    """
...
def data_gen(docs, dkeys, batch_size=64):
    """
        Batch generator
    """
...
def run_dnn(data_name, dkeys):
    ...
    dev_data, _ = load_data_iter(
        data_name, dkeys, suffix='dev'
    )
    best_dev = 0
